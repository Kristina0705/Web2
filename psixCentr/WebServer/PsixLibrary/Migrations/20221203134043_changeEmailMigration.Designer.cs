...
namespace CinemaLibrary.Migrations
{
    ...
    [Migration("20221203134043_changeEmailMigration")]
    partial class changeEmailMigration
    {
            ...
            modelBuilder.Entity("PsixLibrary.Entity.TypeAppeal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TypeName = "Трудности в общении"
                        },
                        new
                        {
                            ID = 2,
                            Description = "Описание типа 2",
                            TypeName = "Семейные проблемы"
                        },
                        new
                        {
                            ID = 3,
                            Description = "Описание типа 3",
                            TypeName = "Фобии"
                        },
                        new
                        {
                            ID = 4,
                            Description = "Описание типа 4",
                            TypeName = "Депрессивные, кризисные состояния"
                        },
                        new
                        {
                            ID = 5,
                            Description = "Описание типа 5",
                            TypeName = "Другое"
                        });
                });
            ...
            modelBuilder.Entity("PsixLibrary.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 2,
                            Email = "twinklegestroo@gmail.com",
                            IsPsychologist = true,
                            Name = "Василий",
                            Pass = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3",
                            Surname = "Безумов"
